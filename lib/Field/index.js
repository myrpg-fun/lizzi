...
let zzTemplate = require('../zzTemplate');
let {zzLink, zzLinkAdd} = require('./zzLink');
...
class zzLinkDataField extends zzLinkAdd{
    async removeDOM(){
...
class Field extends Event{
    async removeDOM(){
        if (this.__zzRemoved === false){
            this.__zzRemoved = true;
